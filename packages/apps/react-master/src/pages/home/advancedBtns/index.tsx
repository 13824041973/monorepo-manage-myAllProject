...
export default function AdvancedBtns() {
	return (
		<div>
			<img
				className=""
				src="https://pic1.zhimg.com/70/v2-d7af3ca52a07ce1c8fa70b0cbde8f75c.webp"
			/>
			<div className="flex flex-1 p-4 flex-wrap">
				<div className="flex flex-col w-1/3 items-center hover:text-blue-500 cursor-pointer">
					...
					<div className="my-2 text-gray-500 hover:text-blue-500">
						live
					</div>
				</div>
